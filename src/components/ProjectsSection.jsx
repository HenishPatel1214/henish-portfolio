...
function ProjectCard({ project }) {
  return (
    ...
    >
      ...
      <h3 className="mt-4 font-display text-xl font-semibold text-brand-50">{project.title}</h3>
      <p className="mt-4 text-sm leading-relaxed text-brand-200/90">{project.description}</p>
