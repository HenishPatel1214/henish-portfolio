...
export default function TeamPulseSection({ musicProfile }) {
  ...
  return (
    <AnimatedSection id="team-pulse" variant="fromRight" className="mx-auto w-full max-w-6xl px-5 py-16 md:px-8 md:py-24">
      <SectionTitle
        eyebrow="Team Pulse"
      ...
      <p className="mt-5 text-xs text-brand-300/80">
